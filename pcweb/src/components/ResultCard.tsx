          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr className="bg-gray-100 font-bold">
                ...
                <td className="px-3 py-2 text-sm">{Math.round(annualSummary.rent).toLocaleString()} 円</td>
              ...
              {currentSchedule.map((item) => (
                <tr key={item.month}>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">{item.month}</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">{item.date}</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">{Math.round(item.rent).toLocaleString()} 円</td>
                  ...
                  <td className="px-3 py-2 whitespace-nowrap text-sm">{Math.round(item.cashFlow || 0).toLocaleString()} 円</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">{Math.round(item.remaining).toLocaleString()} 円</td>
                </tr>
              ))}
            </tbody>
          </table>
